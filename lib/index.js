		...
		handler: async (invocation) => {
			...
			try {
				switch (sub) {
					...
					default: return {
						kind: "error",
						text: t("用法: /spec init | new <目标> | list | show <id> | approve <id> | implement <id> | verify <id> [--deep] | archive <id> | validate [id] | edit <id>", "usage: /spec init | new <goal> | list | show <id> | approve <id> | implement <id> | verify <id> [--deep] | archive <id> | validate [id] | edit <id>")
					};
				}
			} catch (error) {
