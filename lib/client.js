...
`;
		...
		function apply(ctx) {
			...
			function SpecDock(props) {
				...
				const wrap = (row) => (0, react.createElement)("div", { className: "spec-loop-dock" }, row);
				if (!change) {
					if (!initialized) return wrap((0, react.createElement)("div", { className: "spec-loop" }, (0, react.createElement)("span", { className: "spec-loop-glyph" }, "📐"), (0, react.createElement)("span", { className: "spec-loop-hint" }, t("card.init") + " — "), (0, react.createElement)("span", { className: "spec-loop-next" }, "/spec init")));
					return wrap((0, react.createElement)("div", { className: "spec-loop" }, (0, react.createElement)("span", { className: "spec-loop-glyph" }, "📐"), (0, react.createElement)("span", { className: "spec-loop-hint" }, t("card.empty") + " — "), (0, react.createElement)("span", { className: "spec-loop-next" }, "/spec new <goal>")));
				}
				...
				return wrap((0, react.createElement)("div", { className: "spec-loop" }, (0, react.createElement)("span", { className: "spec-loop-glyph" }, "📐"), (0, react.createElement)("span", { className: "spec-loop-id" }, idLabel), (0, react.createElement)("span", { className: "spec-loop-status" + (busy ? " spec-loop-status-active" : "") }, t("status." + change.status)), progress && (change.status === "implementing" || change.status === "implemented") ? (0, react.createElement)("span", {
